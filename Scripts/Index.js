...
function setUpSortie(){
	$.getJSON('https://api.warframestat.us/ps4/sortie', function(data) {
...
//Cetus
function setUpCetus(){
	$.getJSON('https://api.warframestat.us/ps4/cetusCycle', function(data) {
		$('#Cetus').empty();
...
function setUpAlerts(){
	$.getJSON('https://api.warframestat.us/ps4/alerts', function(data) {
...
//darvo
function setUpDarvo(){
	$.getJSON('https://api.warframestat.us/ps4/dailyDeals', function(darvoData) {
		$('#Darvo').empty();
...
//news
function setUpNews(){
	$.getJSON('https://api.warframestat.us/ps4/news', function(newsData) {
		$('#News').empty();
		var eta;
...
function setUpSyndicate(){
	$.getJSON('https://api.warframestat.us/ps4/syndicateMissions', function(synData) {
		$('#Syndicate').empty();
...
//Baro Ki'Teer
function setUpBaro(){
	$.getJSON('https://api.warframestat.us/ps4/voidTrader', function(baroData) {
		$('#Baro').empty();
...
function setUpInvasions(){
	$.getJSON('https://api.warframestat.us/ps4/invasions', function(invData) {
		$('#Invasions').empty();
