...
function setUpSortie(){
	var url = 'https://api.warframestat.us/pc/sortie';
	var zDdata = {};
...
function setUpAlerts(){
	var url = 'https://api.warframestat.us/pc/alerts';
	var zDdata = {};
...
var buildAlertsTable = function(data){ //used to build table
	...
	setInterval(function() {
		var changes = false;
		$.getJSON('https://api.warframestat.us/pc/alerts', function(alertData) {
...
function buildVoidTable(voidData){
	...
	setInterval(function() {
		var changes = false;
		$.getJSON('https://api.warframestat.us/pc/fissures', function(voidData) {
...
//darvo
function setUpDarvo(){
	var url = 'https://api.warframestat.us/pc/dailyDeals';
	var zDdata = {};
...
//news
function setUpNews(){
	var url = 'https://api.warframestat.us/pc/news';
	var zDdata = {};
...
//Baro Ki'Teer
function setUpBaro(){
	var url = 'https://api.warframestat.us/pc/voidTrader';
	var zDdata = {};
...
function setUpInvasions(){
	var url = 'https://api.warframestat.us/pc/invasions';
	var zDdata = {};
