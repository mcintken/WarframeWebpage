...
function setUpSortie(){
	$.getJSON('https://api.warframestat.us/pc/sortie', function(data) {
...
function setUpAlerts(){
	$.getJSON('https://api.warframestat.us/pc/alerts', function(data) {
...
//darvo
function setUpDarvo(){
	$.getJSON('https://api.warframestat.us/pc/dailyDeals', function(darvoData) {
		$('#Darvo').empty();
...
//news
function setUpNews(){
	$.getJSON('https://api.warframestat.us/pc/news', function(newsData) {
		$('#News').empty();
		var eta;
...
function setUpSyndicate(){
	$.getJSON('https://api.warframestat.us/pc/syndicateMissions', function(synData) {
		$('#Syndicate').empty();
...
//Baro Ki'Teer
function setUpBaro(){
	$.getJSON('https://api.warframestat.us/pc/voidTrader', function(baroData) {
		$('#Baro').empty();
...
function setUpInvasions(){
	$.getJSON('https://api.warframestat.us/pc/invasions', function(invData) {
		$('#Invasions').empty();
