...
function setUpSortie(){
	var url = 'https://api.warframestat.us/xb1/sortie';
	var zDdata = {};
...
//Cetus
function setUpCetus(){
	var url = 'https://api.warframestat.us/xb1/cetusCycle';
	var zDdata = {};
...
function setUpAlerts(){
	var url = 'https://api.warframestat.us/xb1/alerts';
	var zDdata = {};
...
// Void Fissures
function setUpVoid(){
	var url = 'https://api.warframestat.us/xb1/fissures';
	var zDdata = {};
...
//darvo
function setUpDarvo(){
	var url = 'https://api.warframestat.us/xb1/dailyDeals';
	var zDdata = {};
...
//news
function setUpNews(){
	var url = 'https://api.warframestat.us/xb1/news';
	var zDdata = {};
...
function setUpSyndicate(){
	var url = 'https://api.warframestat.us/xb1/syndicateMissions';
	var zDdata = {};
...
function setUpInvasions(){
	var url = 'https://api.warframestat.us/xb1/invasions';
	var zDdata = {};
